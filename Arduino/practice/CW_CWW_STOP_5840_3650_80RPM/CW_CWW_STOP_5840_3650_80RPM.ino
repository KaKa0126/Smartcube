#define ENB 10    //ENB핀으로 PWM 관리 됨.
#define IN3 22
#define IN4 23
#define PWM 12    //PWM 관리 안됨
#define relay 26
#define FG 2
...
/*
  ...
  //5840_3650 Speed SETING 작동 안됨.
  //5840_3650 a : 255~155 값에서 속도측정 신뢰 가능. 약40rpm
*/
...
void Speedcheck(){
  ...
  for(int k = 0; k<100 ;k++){
    ...
    i = i >> 3;                      //i*1000
    c += 60000/i;                    //c : 24V 40RPM 기준으로 측정되는 100개의 값의 합
  }
  currentspeed = c/100;
